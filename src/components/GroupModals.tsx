                ...
                <div className="flex gap-2">
                  ...
                  {isOwner && (
                    <button 
                      ...
                      className="px-3 bg-slate-100 text-black rounded-lg hover:bg-slate-200"
                    >
              ...
              {isOwner ? (
                ...
                <div className="pt-4 border-t border-slate-100">
                   <button 
                      ...
                      className="w-full py-2 px-4 border border-slate-200 text-black rounded-lg font-medium hover:bg-slate-50 flex items-center justify-center gap-2"
                    >
