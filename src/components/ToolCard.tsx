...
import { Tag, DollarSign, User, Calendar } from 'lucide-react';
    ...
    <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden hover:shadow-md transition-shadow flex flex-col h-full">
      ...
      <div className="p-4 flex-1 flex flex-col">
        <div className="flex justify-between items-start mb-2">
          ...
          <span className="flex items-center text-black/80 text-sm">
            <DollarSign className="w-3 h-3" />
            {tool.price}
          </span>
        </div>
        
        <p className="text-black/80 text-sm mb-4 line-clamp-2 flex-1">{tool.description}</p>
        ...
        <div className="flex items-center gap-2 mb-4 text-xs text-black/60">
