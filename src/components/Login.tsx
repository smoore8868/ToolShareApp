        ...
        <div className="p-8">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <button 
              type="button"
              onClick={handleSocialLogin}
              className="flex items-center justify-center gap-2 py-2.5 border bg-black border-black rounded-xl hover:bg-text-black transition-colors font-medium text-text-black"
            >
