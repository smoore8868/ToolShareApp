    ...
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden">
        <div className="bg-primary p-8 text-center">
          ...
          <p className="text-white/80">Inventory, Share, Borrow.</p>
        </div>
        ...
        <div className="p-8">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {isRegister && (
              <div>
                ...
                <div className="relative">
                  <UserIcon className="absolute left-3 top-3 w-5 h-5 text-black/40" />
                  <input 
                    type="text" 
                    value={name}
                    onChange={(e) => setName(e.target.value)}
                    className="w-full pl-10 pr-4 py-2.5 border rounded-xl focus:ring-2 focus:ring-primary focus:outline-none text-black"
            ...
            <div>
              ...
              <div className="relative">
                <Mail className="absolute left-3 top-3 w-5 h-5 text-black/40" />
                <input 
                  type="email" 
                  value={email}
            ...
            <div>
              ...
              <div className="relative">
                <Lock className="absolute left-3 top-3 w-5 h-5 text-black/40" />
                <input 
                  type="password" 
                  value={password}
          ...
          <div className="my-6 flex items-center gap-4">
            ...
            <span className="text-black/40 text-sm">or continue with</span>
            <div className="h-px bg-slate-200 flex-1"></div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <button 
              ...
              className="flex items-center justify-center gap-2 py-2.5 border border-slate-200 rounded-xl hover:bg-slate-50 transition-colors font-medium text-black"
            >
